...
User.create name: 'Marcos', status: :active, kind: :manager, email: 'manager2@teste.com', password: 123456
User.create name: 'Daniel', status: :active, kind: :manager, email: 'manager@teste.com', password: 123456
